...
import '../../onboarding/presentation/school_registration_page.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => const _OnboardingRouterWidget(),
                      ),
                    );
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF8B1A00), Color(0xFFC17F24)],
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFF8B1A00).withOpacity(.30),
                          blurRadius: 14,
...
class _OnboardingRouterWidget extends StatelessWidget {
  const _OnboardingRouterWidget();
  @override
  Widget build(BuildContext context) => const SchoolRegistrationPage();
}
